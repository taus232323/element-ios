...
struct AvatarHeaderView<Footer: View>: View {
    ...
    init(room: RoomDetails,
        ...
        if let roomAlias = room.canonicalAlias {
            ...
            subtitle = heroes[0].userID.matrixDisplayNameWithAt
        } else {
            subtitle = nil
        }
    ...
    init(accountOwner: RoomMemberDetails,
        ...
        title = dmRecipientProfile.displayName ?? dmRecipientProfile.displayableUserID
        subtitle = dmRecipientProfile.displayName == nil ? nil : dmRecipientProfile.displayableUserID
    ...
    init(user: UserProfileProxy,
        ...
        title = user.displayName ?? user.displayableUserID
        subtitle = user.displayName == nil ? nil : user.displayableUserID
